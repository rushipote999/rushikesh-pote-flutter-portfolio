import {
  M as MotionGlobalConfig,
  n as noop,
  c as clamp,
  p as pipe,
  m as millisecondsToSeconds,
  s as secondsToMilliseconds,
  v as velocityPerSecond,
  i as invariant,
  a as progress,
  b as isEasingArray,
  e as easingDefinitionToFunction,
  d as easeInOut,
  f as memo,
  g as isBezierDefinition,
  h as circInOut,
  j as backInOut,
  k as anticipate,
  S as SubscriptionManager,
  l as isNumericalString,
  o as isZeroValueString,
  q as isObject,
  r as circOut,
  t as addUniqueItem,
  u as removeItem,
...
const mask = {
  ...
  getAnimatableNone: (v) => {
    ...
    return transformer(
      parsed.map((v2) =>
        typeof v2 === "number" ? 0 : typeof v2 === "object" ? { ...v2, alpha: 1 } : v2,
      ),
    );
  },
};
...
function buildProjectionTransform(delta, treeScale, latestTransform) {
  ...
  if (latestTransform) {
    ...
    if (pathRotation) transform2 += `rotate(${pathRotation}deg) `;
