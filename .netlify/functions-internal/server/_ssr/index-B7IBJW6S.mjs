  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    ...
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className:
          "absolute inset-0 bg-[radial-gradient(ellipse_at_top,oklch(0.2_0.08_290/0.45),transparent_60%)]",
      }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className:
          "absolute top-[-10%] left-[-5%] h-[500px] w-[500px] rounded-full bg-[oklch(0.55_0.25_295/0.35)] blur-[120px] animate-blob",
      }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className:
          "absolute top-[30%] right-[-10%] h-[600px] w-[600px] rounded-full bg-[oklch(0.6_0.22_240/0.3)] blur-[140px] animate-blob",
        style: { animationDelay: "-7s" },
      }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className:
          "absolute bottom-[-10%] left-[20%] h-[550px] w-[550px] rounded-full bg-[oklch(0.75_0.18_200/0.25)] blur-[130px] animate-blob",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className:
          "absolute inset-0 bg-[linear-gradient(to_bottom,transparent,var(--background)_95%)]",
      }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(motion.header, {
    ...
    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
              className: "grid h-9 w-9 place-items-center rounded-lg gradient-primary glow",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(CodeXml, {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
              onClick: toggleTheme,
              className:
                "grid h-9 w-9 place-items-center rounded-lg bg-white/5 border border-white/5 dark:bg-white/5 dark:border-white/5 bg-black/5 border-black/5 hover:bg-white/10 dark:hover:bg-white/10 hover:bg-black/10 transition-colors text-muted-foreground hover:text-foreground cursor-pointer",
              "aria-label": "Toggle dark/light mode",
              children:
                theme === "dark"
                  ? /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { className: "h-4.5 w-4.5" })
                  : /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { className: "h-4.5 w-4.5" }),
            }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", {
              href: "#contact",
              className:
                "hidden rounded-full gradient-primary px-5 py-2 text-sm font-medium text-background transition-transform hover:scale-105 md:inline-block",
              children: "Hire Me",
            }),
          ],
        }),
...
function MagneticButton({ children, href, onClick, variant = "primary", target, rel }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(motion.a, {
    ref,
    href,
    onClick,
    target,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, {
              ...
              className:
                "glass inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-xs font-medium",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, {
                  className: "h-3.5 w-3.5 text-[oklch(0.85_0.18_200)]",
                }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                  children: "2+ Years Experience · Available for Work",
                }),
              ],
            }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.h1, {
              ...
              className:
                "mt-6 text-6xl font-extrabold leading-[1.02] tracking-tight sm:text-7xl lg:text-[5.5rem]",
              children: [
                "Hi, I'm ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                  className: "gradient-text",
                  children: "Rushikesh Pote",
                }),
              ],
            }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                  className:
                    "ml-1 inline-block h-7 w-[3px] bg-[oklch(0.75_0.18_220)] animate-blink",
                }),
              ],
            }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(motion.p, {
              ...
              children:
                "Crafting beautiful, performant cross-platform mobile experiences with Flutter, Firebase, and modern state management. Turning ideas into production-ready apps that users love.",
            }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, {
              initial: { opacity: 0, y: 20 },
              animate: { opacity: 1, y: 0 },
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(MagneticButton, {
                  href: "#projects",
                  variant: "primary",
                  children: [
                    "View Projects",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
              className: "absolute -inset-1 rounded-full glass-strong",
            }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, {
              animate: { y: [0, -14, 0] },
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                  className:
                    "pointer-events-none absolute inset-0 rounded-full ring-1 ring-inset ring-[oklch(0.85_0.18_220/0.4)] [box-shadow:inset_0_0_30px_oklch(0.7_0.22_295/0.35)]",
                }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, {
                  ...
                  transition: { duration: 4, repeat: Infinity },
                  className:
                    "glass-strong absolute -left-6 top-1/3 hidden rounded-2xl px-4 py-3 text-sm sm:block",
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                        children: "Building with Flutter",
                      }),
                    ],
                  }),
                }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, {
                  ...
                  className:
                    "glass-strong absolute -right-6 bottom-10 hidden rounded-2xl px-4 py-3 text-sm sm:block",
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                    className: "font-semibold gradient-text",
                    children: "Dart · Firebase",
                  }),
                }),
              ],
            }),
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
              className:
                "glass inline-block rounded-full px-3 py-1 text-xs uppercase tracking-widest text-muted-foreground",
              children: eyebrow,
            }),
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", {
              children:
                "I'm a Flutter Developer with 2+ years of professional experience crafting high-quality mobile applications. From CRM platforms to citizen service apps, I've shipped production software trusted by real users.",
            }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", {
              children:
                "My focus is on clean architecture, beautiful UI, and rock-solid integrations with Firebase, REST APIs, and modern state management patterns. I care deeply about the small details that make an app feel premium.",
            }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", {
              children:
                "When I'm not building, I'm exploring new frameworks, contributing to side projects, and pushing the boundaries of what's possible on mobile.",
            }),
          ],
        }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
          ...
          children: highlights.map((h, i) =>
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                className:
                  "glass gradient-border rounded-2xl p-5 transition-transform hover:-translate-y-1",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                    className: "grid h-10 w-10 place-items-center rounded-xl gradient-primary",
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(h.icon, {
                      className: "h-5 w-5 text-background",
                    }),
                  }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, {
    ...
    children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
          className:
            "absolute inset-0 rounded-2xl opacity-50 transition-opacity duration-300 group-hover:opacity-100",
          style: {
            background:
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
          className: "absolute inset-0 rounded-2xl glass-strong",
        }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className:
            "relative flex h-full flex-col items-center justify-center gap-3 p-4 text-center",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
              className:
                "grid h-12 w-12 place-items-center rounded-xl bg-white/5 ring-1 ring-white/10 transition-transform duration-300 group-hover:scale-110",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                      className: `h-1 w-12 rounded-full bg-gradient-to-r ${g.accent}`,
                    }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                ...
                children: g.skills.map((s, i) =>
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SkillCard, { skill: s, index: i }, s.name),
                ),
              }),
            ],
          },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, {
    ...
    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
          className:
            "absolute left-4 top-2 bottom-2 w-px bg-gradient-to-b from-[oklch(0.68_0.25_300)] via-[oklch(0.7_0.22_250)] to-transparent md:left-6",
        }),
        items$1.map((item, i) =>
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                  className:
                    "absolute left-0 top-1 grid h-9 w-9 place-items-center rounded-full gradient-primary glow md:h-12 md:w-12",
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, {
                    className: "h-4 w-4 text-background md:h-5 md:w-5",
                  }),
                }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "li",
                          {
                            ...
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                                className:
                                  "mt-2 h-1.5 w-1.5 flex-shrink-0 rounded-full gradient-primary",
                              }),
                              p,
                            ],
                          },
      ...
      children: projects.map((p, i) =>
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.article,
          {
            ...
            className:
              "group glass gradient-border relative overflow-hidden rounded-3xl p-7 transition-shadow duration-300 hover:shadow-[0_20px_60px_-20px_oklch(0.7_0.22_295/0.55)]",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(p.icon, {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("ul", {
                    className: "mt-5 grid grid-cols-2 gap-1.5 text-xs text-muted-foreground",
                    children: p.features.map((f) =>
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "li",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                              className: "h-1 w-1 rounded-full gradient-primary",
                            }),
                            " ",
                            f,
                          ],
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                    ...
                    children: p.tech.map((t) =>
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        ...
                        {
                          className:
                            "glass rounded-full px-3 py-1 text-[11px] font-medium uppercase tracking-wider",
                          children: t,
                        },
                        t,
                      ),
                    ...
                    children: [
                      p.playStore &&
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", {
                          ...
                          rel: "noopener noreferrer",
                          className:
                            "inline-flex items-center gap-1.5 rounded-full gradient-primary px-4 py-2 text-xs font-semibold text-background transition-transform hover:scale-105",
                          children: [
                      ...
                      !p.playStore &&
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", {
                          className:
                            "inline-flex items-center gap-1.5 rounded-full bg-white/5 px-4 py-2 text-xs font-semibold text-muted-foreground",
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, {
                      ...
                      p.github &&
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", {
                          ...
                          rel: "noopener noreferrer",
                          className:
                            "glass inline-flex items-center gap-1.5 rounded-full px-4 py-2 text-xs font-semibold hover:bg-white/10",
                          children: [
      ...
      children: items.map((a, i) =>
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            className:
              "glass gradient-border group relative overflow-hidden rounded-2xl p-6 transition-transform hover:-translate-y-1",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                className: "grid h-11 w-11 place-items-center rounded-xl gradient-primary",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(a.icon, {
                  className: "h-5 w-5 text-background",
                }),
              }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, {
    ...
    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      ...
      children: [
          ...
          children: contacts.map((c, i) =>
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.a,
              {
                ...
                className:
                  "glass gradient-border flex items-center gap-4 rounded-2xl p-4 transition-transform hover:-translate-y-0.5",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                    className: "grid h-11 w-11 place-items-center rounded-xl gradient-primary",
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(c.icon, {
                      className: "h-5 w-5 text-background",
                    }),
                  }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.form, {
          initial: { opacity: 0, y: 20 },
          whileInView: { opacity: 1, y: 0 },
          viewport: { once: true },
          transition: { duration: 0.5 },
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("input", {
                    ...
                    className:
                      "mt-2 w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm outline-none transition-colors placeholder:text-muted-foreground focus:border-[oklch(0.7_0.22_295)]",
                  }),
                ],
              }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", {
                    ...
                    className:
                      "mt-2 w-full resize-none rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm outline-none transition-colors placeholder:text-muted-foreground focus:border-[oklch(0.7_0.22_295)]",
                  }),
                ],
              }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
                ...
                disabled: sending,
                className:
                  "group inline-flex items-center justify-center gap-2 rounded-full gradient-primary px-6 py-3 text-sm font-semibold text-background glow transition-transform hover:scale-[1.02] disabled:opacity-70",
                children: sending
                  ? "Sending..."
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", {
    className: "relative px-5 pb-10 pt-16",
    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "mx-auto max-w-6xl",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
          className:
            "h-px bg-gradient-to-r from-transparent via-[oklch(0.7_0.22_295)]/60 to-transparent",
        }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    ...
                    "aria-label": s.label,
                    className:
                      "glass grid h-10 w-10 place-items-center rounded-full transition-transform hover:-translate-y-0.5 hover:bg-white/10",
